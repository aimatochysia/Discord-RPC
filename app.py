...
def process_array(input_array):
    ...
    for element in input_array:
        ...
        #etc
        if ":\\" in  element:
            output_array.append(["File Explorer", "Gif", "Browsing Files. . ."])
        elif "Program Manager" in  element:
            print ("disincluding Program Manager")
        elif "Windows Input Experience" in  element:
            print ("disincluding Windows programs")
        elif "Settings" in  element:
            print ("disincluding Settings")
        elif "Discord RPC Shortcut" in element:
            print ("disincluding this shortcut")
            
        # Check for VS code
        elif "Visual Studio" in element:
        ...
        #Social Medias
            ...
            output_array.append(["discord logo", "Gif", "Obviously online in discord"])
        
        elif "LINE" in element:
            output_array.append(["line messenger", "Meme", "Online in LINE"])
        
        elif "Whatsapp" in element:
            output_array.append(["whatsapp logo", "Gif", "Online in Whatsapp"])
            
        elif "Telegram" in element:
            output_array.append(["telegram logo", "Gif", "Online in Telegram"])
